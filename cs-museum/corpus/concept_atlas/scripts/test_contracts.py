...
from validate_atlas import ROOT, validate_graph, validate_primary_source_set
...
def main():
    ...
    bad_source = [(Path("bad.json"), {"sources": ["https://example.com/opinion"]})]
    check(validate_primary_source_set(bad_source)[0], "non-primary canonical sources must fail")
