const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/MasteryPage-DKKybawU.js","assets/vendor-query-CVs38Wia.js","assets/vendor-react-KgNWHp-S.js","assets/SandboxFrame-CUs6vhgf.js","assets/vendor-editor-B0XDVFHE.js","assets/useLibrary-R6yOHJ9Y.js","assets/vendor-icons-afXXY6TB.js","assets/FormattedMarkdown-DXZ7CHn6.js","assets/PlaygroundPage-DgikKyk6.js","assets/UniversalAiAssistant-BSdKSSao.js","assets/RapidFirePage-Djg0Aphd.js","assets/LearnPage-BHOUg8g4.js","assets/index-Bd35tj6t.js","assets/confetti.module-C94ZD2ww.js","assets/ProjectsPage-D9WCwDmx.js"])))=>i.map(i=>d[i]);
var df=Object.defineProperty;var uf=(l,h,b)=>h in l?df(l,h,{enumerable:!0,configurable:!0,writable:!0,value:b}):l[h]=b;var gh=(l,h,b)=>uf(l,typeof h!="symbol"?h+"":h,b);import{Q as hf,j as S,a as mf}from"./vendor-query-CVs38Wia.js";import{a as qh,b as pf,R as Ls,r as we,u as ff,N as bh,c as gf,d as Kt,O as bf,B as vf,e as yf,f as Fe}from"./vendor-react-KgNWHp-S.js";import{S as ho,G as xf,L as wf,Z as kf,P as Sf,C as Tf,a as Of,T as Nf,R as Af,M as Cf,b as Df}from"./vendor-icons-afXXY6TB.js";(function(){const h=document.createElement("link").relList;if(h&&h.supports&&h.supports("modulepreload"))return;for(const A of document.querySelectorAll('link[rel="modulepreload"]'))u(A);new MutationObserver(A=>{for(const z of A)if(z.type==="childList")for(const j of z.addedNodes)j.tagName==="LINK"&&j.rel==="modulepreload"&&u(j)}).observe(document,{childList:!0,subtree:!0});function b(A){const z={};return A.integrity&&(z.integrity=A.integrity),A.referrerPolicy&&(z.referrerPolicy=A.referrerPolicy),A.crossOrigin==="use-credentials"?z.credentials="include":A.crossOrigin==="anonymous"?z.credentials="omit":z.credentials="same-origin",z}function u(A){if(A.ep)return;A.ep=!0;const z=b(A);fetch(A.href,z)}})();const Rf="modulepreload",Ef=function(l){return"/"+l},vh={},vi=function(h,b,u){let A=Promise.resolve();if(b&&b.length>0){let j=function(T){return Promise.all(T.map(L=>Promise.resolve(L).then(O=>({status:"fulfilled",value:O}),O=>({status:"rejected",reason:O}))))};document.getElementsByTagName("link");const q=document.querySelector("meta[property=csp-nonce]"),B=(q==null?void 0:q.nonce)||(q==null?void 0:q.getAttribute("nonce"));A=j(b.map(T=>{if(T=Ef(T),T in vh)return;vh[T]=!0;const L=T.endsWith(".css"),O=L?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${T}"]${O}`))return;const R=document.createElement("link");if(R.rel=L?"stylesheet":Rf,L||(R.as="script"),R.crossOrigin="",R.href=T,B&&R.setAttribute("nonce",B),document.head.appendChild(R),L)return new Promise((Y,X)=>{R.addEventListener("load",Y),R.addEventListener("error",()=>X(new Error(`Unable to preload CSS for ${T}`)))})}))}function z(j){const q=new Event("vite:preloadError",{cancelable:!0});if(q.payload=j,window.dispatchEvent(q),!q.defaultPrevented)throw j}return A.then(j=>{for(const q of j||[])q.status==="rejected"&&z(q.reason);return h().catch(z)})};var ro={exports:{}},lo={};/**
 * @license React
