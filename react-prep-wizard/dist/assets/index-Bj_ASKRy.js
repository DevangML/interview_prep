const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/MasteryPage-CwhIWn7X.js","assets/vendor-query-CVs38Wia.js","assets/vendor-react-KgNWHp-S.js","assets/KeyboardAccessoryBar-hSpyyfiM.js","assets/vendor-editor-B0XDVFHE.js","assets/vendor-icons-DvKizMOa.js","assets/useLibrary-i6FSJWr2.js","assets/FormattedMarkdown-DZxM5M6J.js","assets/BottomSheetModal-Dq47BwMM.js","assets/PlaygroundPage-D5IyqniF.js","assets/NeuralMindTrigger-CbNzY3hs.js","assets/RapidFirePage-BmI2lUhn.js","assets/LearnPage-BI0QAxIg.js","assets/SwipeableCard-dmdGMsGw.js","assets/confetti.module-C94ZD2ww.js","assets/ProjectsPage-Cl9zOBgL.js"])))=>i.map(i=>d[i]);
var xf=Object.defineProperty;var wf=(r,c,m)=>c in r?xf(r,c,{enumerable:!0,configurable:!0,writable:!0,value:m}):r[c]=m;var Ga=(r,c,m)=>wf(r,typeof c!="symbol"?c+"":c,m);import{Q as kf,j as y,a as Sf}from"./vendor-query-CVs38Wia.js";import{a as Hh,b as Tf,R as Ys,r as me,N as Xs,u as Lh,c as Nf,d as Jt,O as Of,B as Af,e as Cf,f as Fe}from"./vendor-react-KgNWHp-S.js";import{S as Qs,G as Df,L as Rf,Z as Ef,P as jf,B as zf,C as Gh,a as Yh,T as Xh,R as Mf,M as qf,b as Uf}from"./vendor-icons-DvKizMOa.js";(function(){const c=document.createElement("link").relList;if(c&&c.supports&&c.supports("modulepreload"))return;for(const A of document.querySelectorAll('link[rel="modulepreload"]'))u(A);new MutationObserver(A=>{for(const N of A)if(N.type==="childList")for(const O of N.addedNodes)O.tagName==="LINK"&&O.rel==="modulepreload"&&u(O)}).observe(document,{childList:!0,subtree:!0});function m(A){const N={};return A.integrity&&(N.integrity=A.integrity),A.referrerPolicy&&(N.referrerPolicy=A.referrerPolicy),A.crossOrigin==="use-credentials"?N.credentials="include":A.crossOrigin==="anonymous"?N.credentials="omit":N.credentials="same-origin",N}function u(A){if(A.ep)return;A.ep=!0;const N=m(A);fetch(A.href,N)}})();const _f="modulepreload",Bf=function(r){return"/"+r},wh={},wi=function(c,m,u){let A=Promise.resolve();if(m&&m.length>0){let O=function(E){return Promise.all(E.map(B=>Promise.resolve(B).then(T=>({status:"fulfilled",value:T}),T=>({status:"rejected",reason:T}))))};document.getElementsByTagName("link");const C=document.querySelector("meta[property=csp-nonce]"),R=(C==null?void 0:C.nonce)||(C==null?void 0:C.getAttribute("nonce"));A=O(m.map(E=>{if(E=Bf(E),E in wh)return;wh[E]=!0;const B=E.endsWith(".css"),T=B?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${E}"]${T}`))return;const M=document.createElement("link");if(M.rel=B?"stylesheet":_f,B||(M.as="script"),M.crossOrigin="",M.href=E,R&&M.setAttribute("nonce",R),document.head.appendChild(M),B)return new Promise((V,J)=>{M.addEventListener("load",V),M.addEventListener("error",()=>J(new Error(`Unable to preload CSS for ${E}`)))})}))}function N(O){const C=new Event("vite:preloadError",{cancelable:!0});if(C.payload=O,window.dispatchEvent(C),!C.defaultPrevented)throw O}return A.then(O=>{for(const C of O||[])C.status==="rejected"&&N(C.reason);return c().catch(N)})};var hl={exports:{}},ml={};/**
 * @license React
