...
> - **Output file:** `job_hunt/cv/main_<company>_<role><source-extension>` / `job_hunt/cover_letters/cover_<company>_<role><source-extension>`; copy any class/package/font files the template needs into the output directory, or reference them by relative path
<!-- END ACTIVE-TEMPLATE -->
```
